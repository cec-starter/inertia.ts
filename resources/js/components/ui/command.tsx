...
const CommandDialog = ({ children, ...props }: DialogProps & { className?: string }) => {
    return (
        <Dialog {...props}>
            <DialogContent className={props.className ?? "overflow-hidden p-0"}>
...
const CommandItem = React.forwardRef<
     ...
     * @param className - The class name to append to the root element
     * @param props - The props to pass to the underlying `CommandPrimitive.Item` component
     * @param ref - The ref object to pass to the underlying `CommandPrimitive.Item` component
     * @returns The command item component
     */
>(({ className, ...props }, ref) => (
